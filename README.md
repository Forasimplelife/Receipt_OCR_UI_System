...
この記事は、OCR認識UIシステムの構築について紹介しています。このシステムは、レシート画像から店舗名、日時、金額などの重要な情報を迅速かつ正確に抽出するために設計された自動化ソリューションです。具体的には、2つのAIモデル（分類モデルと物体検出モデル）とEasyOCR、さらにStreamlitを用いたUIを統合して構築されています。
